...
export const Header = () => {
    ...
    return (
        <header>
            <nav className="bg-white border-b-2 border-gray-900 dark:bg-gray-900 dark:border-b-1 dark:border-gray-900">
                <div className="max-w-screen flex flex-wrap items-center justify-between mx-2 p-4">
                    ...
                    <div className={`${hidden ? 'hidden' : ''} items-center justify-between w-full md:flex md:w-auto md:order-1" id="navbar-search`}>
                        ...
                        <ul className="text-base flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                            <li>
